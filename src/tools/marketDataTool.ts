...
const MOCK_DATA: Record<string, Record<string, unknown>> = {
  AAPL: {
    ...
    fundamentals: { marketCap: 2_800_000_000_000, PE: 28.5, PB: 45.2, ROE: 1.47, debtToEquity: 1.76, dividendYield: 0.005 },
    financials: { revenue: 383_285_000_000, operatingIncome: 114_301_000_000, netIncome: 96_995_000_000, operatingMargin: 0.298, netMargin: 0.253 },
  },
  "005930": {
    price: { current: 72_000, change: -500, volume: 12_000_000, high52w: 88_800, low52w: 59_000 },
    fundamentals: { marketCap: 430_000_000_000_000, PE: 12.8, PB: 1.3, ROE: 0.085, debtToEquity: 0.35, dividendYield: 0.018 },
    financials: { revenue: 258_935_000_000_000, operatingIncome: 6_567_000_000_000, netIncome: 15_487_000_000_000, operatingMargin: 0.025, netMargin: 0.06 },
  },
};
...
export const marketDataTool: ToolDefinition<typeof parameters> = {
  name: "market_data",
  label: "시장 데이터 조회",
  description: "종목의 시세, 재무지표, 재무제표 데이터를 조회합니다. 정확한 수치를 반환하므로 투자 분석의 기초 데이터로 사용하세요.",
  parameters,
