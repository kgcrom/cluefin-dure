...
const MOCK_UNIVERSE = [
  { ticker: "AAPL", market: "US", sector: "Technology", PE: 28.5, PB: 45.2, ROE: 147, marketCap: 2_800_000_000_000 },
  { ticker: "MSFT", market: "US", sector: "Technology", PE: 35.2, PB: 12.8, ROE: 38, marketCap: 3_100_000_000_000 },
  { ticker: "NVDA", market: "US", sector: "Technology", PE: 65.3, PB: 52.1, ROE: 115, marketCap: 2_200_000_000_000 },
  { ticker: "005930", market: "KR", sector: "Technology", PE: 12.8, PB: 1.3, ROE: 8.5, marketCap: 430_000_000_000_000 },
  { ticker: "000660", market: "KR", sector: "Technology", PE: 8.5, PB: 1.8, ROE: 22, marketCap: 85_000_000_000_000 },
  { ticker: "035420", market: "KR", sector: "Communication Services", PE: 22.1, PB: 3.2, ROE: 12, marketCap: 45_000_000_000_000 },
  { ticker: "JPM", market: "US", sector: "Financials", PE: 11.5, PB: 1.8, ROE: 15, marketCap: 590_000_000_000 },
...
export const screenerTool: ToolDefinition<typeof parameters> = {
  name: "stock_screener",
  label: "종목 스크리닝",
  description: "재무 지표 조건으로 종목을 스크리닝합니다. PE, PB, ROE, 시가총액 등의 조건을 조합하여 투자 후보를 필터링합니다.",
  parameters,
